...
public class BookManagementSystem extends JFrame {
    ...
    private static void initializeDB() {
        String sqlCreateBooks = "CREATE TABLE IF NOT EXISTS books (book_name TEXT, author TEXT)";
        String sqlCreateUsers = "CREATE TABLE IF NOT EXISTS users (username TEXT PRIMARY KEY, password TEXT)";
